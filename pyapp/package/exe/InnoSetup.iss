...
OutputBaseFilename=QMT自动跟单-V0.9.5_Windows
...
[Files]
Source: "C:\Users\mubin\Desktop\qmt-auto-order\build\{#MyAppName}\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs ignoreversion
